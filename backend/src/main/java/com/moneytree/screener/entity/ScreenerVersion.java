...
public class ScreenerVersion {
    ...
    @Id
    @Column(name = "screener_version_id", columnDefinition = "uuid")
    private UUID screenerVersionId;
    ...
    // Getters and setters
    public UUID getScreenerVersionId() { return screenerVersionId; }
    public void setScreenerVersionId(UUID screenerVersionId) { this.screenerVersionId = screenerVersionId; }
