export const environment = {
  ...
  enginesApiUrl: 'http://socketengine.tailce422e.ts.net/engines',
  enginesWebSocketUrl: 'ws://socketengine.tailce422e.ts.net', // Base WebSocket URL (append /ws/indices/all)
  enginesHttpUrl: 'http://socketengine.tailce422e.ts.net', // Base HTTP URL for SockJS connections (append /ws/indices/all)
